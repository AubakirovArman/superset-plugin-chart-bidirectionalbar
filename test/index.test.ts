 ...
 * under the License.
 */
import { SupersetPluginChartBidirectionalbar } from '../src';
 ...
 */
describe('superset-plugin-chart-bidirectionalbar', () => {
  it('exists', () => {
    expect(SupersetPluginChartBidirectionalbar).toBeDefined();
  });
});
